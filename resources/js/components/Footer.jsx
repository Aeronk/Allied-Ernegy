...
export default function Footer({ settings: directSettings }) {
    const { props } = usePage();
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="flex items-center gap-3 mb-4">
                            ...
                            <span className="font-display text-white text-xl">{settings.site_name || 'Allied Energies Ltd'}</span>
                        </Link>
                        <p className="text-sm leading-relaxed mb-6 max-w-sm">
                            {settings.site_description || 'Harnessing the boundless power of ocean waves to deliver clean, predictable, and sustainable energy solutions for coastal communities and industries worldwide.'}
                        </p>
