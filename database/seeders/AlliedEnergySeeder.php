...
class AlliedEnergySeeder extends Seeder
{
    ...
    private function seedServices(): void
    {
        $services = [
            [
                'title' => "Ocean Wave Technology",
                'slug' => 'wave',
                'description' => "Allied Energies harnesses the power of the ocean through Eco Wave Power, a world leader in onshore wave energy. Their patented technology converts the natural movement of waves into grid-ready, zero-emission electricity.",
                'icon' => "Waves",
            ...
            [
                'title' => "The KCT Vortex Turbine",
                'slug' => 'vortex',
                'description' => "A revolutionary micro hydro vortex turbine that operates without the need for waterfalls or high head pressure. The KCT uses rotational kinetic gravitational energy to generate continuous hydroelectric power.",
                'icon' => "Droplets",
            ...
            [
                ...
                'slug' => 'hydrogen',
                'description' => "By merging wave and hydro energy sources, we provide sustainable electricity to power green hydrogen electrolysis systems for industrial, transport, and off-grid applications.",
                'icon' => "Zap",
            ...
            [
                ...
                'slug' => 'wind',
                'description' => "Developing and operating onshore and nearshore wind power systems to diversify renewable generation capacity and reinforce supply stability.",
                'icon' => "Wind",
            ...
            [
                'title' => "Oxygen Production Systems",
                'slug' => 'oxygen',
                'description' => "Independent oxygen production systems powered entirely by renewable electricity, extracting high-purity oxygen for industrial, medical, and energy applications.",
                'icon' => "Factory",
    ...
    private function seedPartners(): void
    {
        $partners = [
            ...
            [
                'name' => "KourisPower",
                'description' => "Strategic partner for the KCT Vortex Turbine technology.",
            ...
            [
                ...
                'description' => "Collaborating to develop an on-shore energy plan.",
    ...
    private function seedProjects(): void
    {
        $projects = [
            [
                'title' => "Ngqura Port SA",
                'location' => "South Africa",
                'description' => "Successful Feasibility Study for 8.3MW wave energy installation, demonstrating the potential for large-scale marine power in the region.",
            ...
            [
                'title' => "Fraserburgh Harbour Expansion",
                'location' => "Scotland",
                'description' => "Integrating marine-based renewable technologies with the harbour's masterplan for deep-water basins and modern quayside space.",
            ...
            [
                'title' => "Peterhead Port Hub",
                'location' => "Scotland",
                'description' => "Strategic base for wave power, hydrogen generation, and storage, leveraging deep-water capabilities for offshore logistics.",
